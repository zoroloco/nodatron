...
var pathUtil = require('path'),
    ...
    maestro  = require(pathUtil.join(__dirname,'./maestroConnection.js')),
...
function Nodatron(properties){
  ...
  else if(properties.device == 'maestro'){
      this._serialConnection = new maestro()
  }
  else if(properties.device == 'pizero'){
